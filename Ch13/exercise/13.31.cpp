...
{
    std::cout << "HasPtr::swap(HasPtr &rhs) between <" << *ps << "> and <"
              << *rhs.ps << ">" << std::endl;
    using std::swap;
    swap(ps, rhs.ps);
    swap(i, rhs.i);
...
{
    // This copy-assignment operator is correct even if the object is assigned
    // to itself. See ex13.11 for the wrong version.
...
int main()
{
    ...
    std::vector<HasPtr> v{"Hello", "World", "P",  "Q", "R", "S",   "T",   "U",
                          "ABC",   "DEF",   "AB", "C", "D", "E",   "F",   "G",
                          "H",     "I",     "J",  "K", "L", "ABC", "DEF", "AB",
                          "C",     "D",     "E",  "J", "K", "L",   "M",   "N"};
    testHasPtrVec(v);
    ...
    std::vector<HasPtr> v2{
        "Hello", "World", "P", "Q", "R", "S", "T", "U", "ABC", "DEF", "AB",
        "C",     "D",     "E", "F", "G", "H", "I", "J", "K",   "L",   "ABC",
        "DEF",   "AB",    "C", "D", "E", "J", "K", "L", "M",   "N",   "O"};
    testHasPtrVec(v2);
